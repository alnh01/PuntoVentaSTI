...
public class Ingresos extends javax.swing.JDialog {
    ...
    public Ingresos(java.awt.Frame parent, boolean modal) throws SQLException {
        super(parent, modal);
        initComponents();
      ...
      columna.getColumn(0).setPreferredWidth(-3);
      columna.getColumn(0).setMaxWidth(-3);
      columna.getColumn(0).setMinWidth(-3);
...
//       
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(tblproductos.getRowCount() < 0){
                            WarningAlert w = new WarningAlert(new JFrame(), true);
                             w.msj1.setText("No hay productos en la tabla");
                             w.msj2.setText("Por favor seleccione busque algun producto");
                             w.msj3.setText("");
                             w.setVisible(true);    
    ...
    public  void CargarModeloTabla() throws SQLException{
        ...
        String buscar = panelingresos.txtbuscar.getText();
...
////
       ...
       tabla.setNumRows(numerosProductos);
        ...
        for (int i = 0; i < numerosProductos; i++) {
            ...
            double pv = productos.getPrecioCompraProducto();
    ...
    public void guardarIngreso(){
      ...
      if(panelingresos.tblingresos.getRowCount() ==0){
                 
            String [] datosProducto = {codigo,barras,nombre, precio,cantidad,importe};
            
            panelingresos.modeloTabla.addRow(datosProducto);
            panelingresos.cargarListenerModeloTabla();
            panelingresos.txtbuscar.setText("");
            dispose();
      ...
      for (int i = 0; i < panelingresos.tblingresos.getRowCount() ; i++) {
          
      Lista.add(panelingresos.tblingresos.getValueAt(i, 0).toString());

                    if( Lista.get(i).equals(codigo)){
                         encontrado  =true ;
                         cantidadEXT  =  panelingresos.tblingresos.getValueAt(i, 4).toString();
                        index = i;
                        break;
                  ...
                  if (encontrado){
                    ...
                    String cantidadActualizada = String.valueOf(cantAct);
                      panelingresos.modeloTabla.setValueAt(cantidadActualizada, index, 4);
                    
                    String precioVenta =panelingresos.modeloTabla.getValueAt(index, 3).toString();
                    ...
                    panelingresos.modeloTabla.setValueAt(importeString, index, 5);
...
if (evt.getKeyCode() == KeyEvent.VK_ESCAPE && this != null){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Ingresos dialog = null;
                try {
                    dialog = new Ingresos(new javax.swing.JFrame(), true);
